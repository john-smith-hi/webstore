        ...
        <div class="col">
            <div class="owl-carousel related-carousel owl-loaded owl-drag">
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(-1777px, 0px, 0px); transition: all 1s ease 0s; width: 4623px;">
                        <div class="owl-item cloned" style="width: 326.55px; margin-right: 29px;">
                            <div class="card product-item border-0">
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="/storage/products/J3mJk8rg90XvXLUKGSjsiQRBsX8IotRpF4vZCXVj.png" alt="">
                                </div>
                        ...
                        <div class="owl-item active" style="width: 326.55px; margin-right: 29px;">
                            <div class="card product-item border-0">
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="/storage/products/J3mJk8rg90XvXLUKGSjsiQRBsX8IotRpF4vZCXVj.png" alt="">
                                </div>
